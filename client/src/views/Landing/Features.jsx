...
const Features = () => {
    ...
    return (
        <div className="my-20 pt-10" id="section_features">
            ...
            <div className='grid md:grid-cols-2 justify-between w-fit mx-auto gap-12'>
                {features.map((feature) => (
                    <div className='max-w-lg flex flex-col gap-4 justify-center items-center w-full mx-auto p-4 transition duration-200 ease-in'>
