...
const FilterCourses = ({filterCourses}) => {
    ...
    return (
        <motion.div
            ...
            className='bg-white dark:bg-gray-900 rounded-lg p-6 hidden md:block md:max-w-xs md:w-full max-h-fit h-full'
        >
            ...
            <div className="flex justify-between items-center mb-2">
                ...
                <button className='bg-gray-100 dark:bg-gray-800 rounded-md font-semibold px-2 py-1 text-sm transition duration-200 ease-in hover:bg-gray-200 dark:hover:bg-gray-700'>
                    Reset Filters
                </button>
            </div>
